...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
    ...
    ALTER ROLE $MICADO_DB_USER IN DATABASE $POSTGRES_DB SET search_path = $KEYCLOAK_DB_SCHEMA;
    ...
    ALTER DEFAULT PRIVILEGES IN SCHEMA $GITEA_DB_SWEBLATE_DB_SCHEMACHEMA GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO $WEBLATE_POSTGRES_USER;
